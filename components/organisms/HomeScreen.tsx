...
const HomeScreen: React.FC = () => {
    ...
    const handleShareRecipe = async (recipe: any): Promise<void> => {
        ...
        recipeText += `⏱️ ${t('home.prepTime')}: ${recipe.prepTime}m | ${t('home.cookTime')}: ${recipe.cookTime}m | ${t('home.totalTime')}: ${recipe.prepTime + recipe.cookTime}m\n`
        recipeText += `🍽️ ${t('home.servings')}: ${recipe.servings} | ${t('home.difficulty')}: ${recipe.difficulty} | ${t('home.cuisine')}: ${recipe.cuisine}\n\n`

        if (recipe.nutrition) {
            recipeText += `📊 ${t('home.nutritionPerServing')}:\n`
            recipeText += `• ${t('home.calories')}: ${recipe.nutrition.calories}\n`
            recipeText += `• ${t('home.protein')}: ${recipe.nutrition.protein}g\n`
            recipeText += `• ${t('home.carbs')}: ${recipe.nutrition.carbs}g\n`
            recipeText += `• ${t('home.fat')}: ${recipe.nutrition.fat}g\n\n`
        }

        if (recipe.ingredients) {
            recipeText += `🛒 ${t('home.ingredients')}:\n`
        ...
        if (recipe.instructions) {
            recipeText += `👨‍🍳 ${t('home.instructions')}:\n`
        ...
        if (recipe.substitutions && recipe.substitutions.length > 0) {
            recipeText += `🔄 ${t('home.substitutions')}:\n`
                            ...
                            <View className="rounded-2xl overflow-hidden border border-zinc-700/50 bg-zinc-800">
                                <View className="p-2">
                                    <View className="flex-row items-center justify-between mb-1">
                                        <Text className="ml-1 text-white text-xs font-semibold">{t('home.calories')}</Text>
                        ...
                        <View className="flex-row justify-between mb-4">
                                ...
                                <View className="rounded-xl overflow-hidden border border-zinc-700/50 bg-zinc-800">
                                    <View className="p-3">
                                        <View className="flex-row items-center justify-between mb-2">
                                            <Text className="text-white text-sm font-semibold">{t('home.pantry')}</Text>
                                        ...
                                        <View className="flex-row justify-between">
                                            <Text className="text-yellow-400 text-xs">{pantryData.expiring} {t('home.expiring')}</Text>
                                        </View>
                                    </View>
                                </View>
                            </TouchableOpacity>
                            ...
                            >
                                <View className="rounded-xl overflow-hidden border border-zinc-700/50 bg-zinc-800">
                                    <View className="p-3">
                                        <View className="flex-row items-center justify-between mb-2">
                                            <Text className="text-white text-sm font-semibold">{t('home.grocery')}</Text>
                                            <Ionicons name="chevron-forward" size={12} color="#9CA3AF" />
                                        </View>
                                        <View className="flex-row h-2 rounded-full overflow-hidden bg-zinc-700/60 mb-2">
                                            {groceryData.total > 0 && (
                                        ...
                                        <View className="flex-row justify-between">
                                            <Text className="text-blue-400 text-xs">{groceryData.pending} {t('home.pending')}</Text>
                                        </View>
                                    </View>
                                </View>
                            </TouchableOpacity>
                            ...
                            <View className="p-6">
                                        ...
                                        <View className="bg-blue-500/20 border border-blue-500/40 rounded-full px-3 py-1 mr-2 mb-2">
                                            <View className="flex-row items-center">
                                                ...
                                                <Text className="text-blue-300 ml-1 text-xs font-semibold">
                                                    {expandedRecipeData.servings || 1} {t('home.servings')}
                                                </Text>
                                            </View>
                                        </View>
                                ...
                                <View className="flex-row mb-6" style={{ gap: 12 }}>
                                    ...
                                    >
                                        ...
                                        <Text className="text-amber-300 font-bold ml-2 text-sm tracking-wide">{t('common.share')}</Text>
                                    </TouchableOpacity>
                                    ...
                                    >
                                        ...
                                        <Text className={`${isFavorite(expandedRecipeData._id || expandedRecipeData.id) ? 'text-pink-300' : 'text-purple-300'} font-bold ml-2 text-sm tracking-wide`}>
                                            {isFavorite(expandedRecipeData._id || expandedRecipeData.id) ? t('recipe.saved') : t('recipe.favorite')}
                                        </Text>
                                    </TouchableOpacity>
                                </View>
                                ...
                                {(expandedRecipeData.nutrition?.calories || expandedRecipeData.nutrition?.protein || expandedRecipeData.nutrition?.carbs || expandedRecipeData.nutrition?.fat) && (
                                    <View className="mb-6">
                                        <View className="flex-row items-center mb-4">
                                            ...
                                            <Text className="text-white text-xl font-bold tracking-tight">{t('recipe.nutrition')}</Text>
                                ...
                                <View className="mb-6">
                                    <View className="flex-row items-center mb-4">
                                        <View className="w-1 h-6 bg-amber-500 rounded-full mr-3" />
                                        <Text className="text-white text-xl font-bold tracking-tight">{t('recipe.ingredients')}</Text>
                                        <View className="flex-1 h-px bg-amber-500/20 ml-4" />
                                    </View>
                                ...
                                <View className="mb-6">
                                    <View className="flex-row items-center mb-5">
                                        <View className="w-1 h-6 bg-amber-500 rounded-full mr-3" />
                                        <Text className="text-white text-xl font-bold tracking-tight">{t('recipe.instructions')}</Text>
                                        <View className="flex-1 h-px bg-amber-500/20 ml-4" />
                                    </View>
                                    ...
                                    <View className="mb-6">
                                        <View className="flex-row items-center justify-between mb-5">
                                            <View className="flex-row items-center">
                                                ...
                                                <Text className="text-white text-xl font-bold tracking-tight">{t('recipe.substitutions')}</Text>
                                            </View>
